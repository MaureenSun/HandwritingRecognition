...
- Install TensorFlow using pip for Python. 
- For TensorFlow's C++ API, you'll need to build TensorFlow from source with CMake. Follow the official TensorFlow documentation : 


FROM TENSOR FLOW REPO: 
